...
export const FilterTable = (props) => {
    ...
    const handleSelect = (id) => {
        if (props.filterValues[props?.filterColumn]?.includes(id)) {
            let selectedLogs = props.filterValues[props?.filterColumn].filter((logId) => logId !== id);
                        ...
                        <div className="row">
                            <div className="col">
                                <div className="form-group">
                                    ...
                                    />
                                    <label className="text-label" style={{ textTransform: 'capitalize' }} htmlFor="saveSelectionName">
