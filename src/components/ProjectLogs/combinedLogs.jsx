            ...
            <th className="small-font">
              <span className="has-sorting">
                <div className="d-flex">
                  ...
                  >
                    <FilterIcon fillColor={`${filterValues.spec_section.length > 0 ? '#2f5aa3' : '#36454F'}`}/>
                  </span>
                </div>
              </span>
            </th>
              ...
              <th className="small-font">
                <span className="has-sorting">
                  <div className="d-flex">
                    ...
                    >
                      <FilterIcon fillColor={`${filterValues.type.length > 0 ? '#2f5aa3' : '#36454F'}`}/>
                    </span>
                  </div>
                </span>
              </th>
              ...
              <th className="small-font">
                <span className="has-sorting">
                  <div className="d-flex">
                    ...
                    >
                      <FilterIcon fillColor={`${filterValues.owner_contractor.length > 0 ? '#2f5aa3' : '#36454F'}`}/>
                    </span>
                  </div>
                </span>
              </th>
              ...
              <th className="small-font">
                <span className="has-sorting">
                  <div className="d-flex">
                    ...
                    >
                      <FilterIcon fillColor={`${filterValues.sd_title.length > 0 ? '#2f5aa3' : '#36454F'}`}/>
                    </span>
                  </div>
                </span>
              </th>
            ...
            <th className="small-font">
              <span className="has-sorting">
                <div className="d-flex">
                  ...
                  >
                    <FilterIcon fillColor={`${filterValues.item_desc.length > 0 ? '#2f5aa3' : '#36454F'}`}/>
                  </span>
                </div>
              </span>
            </th>
              ...
              <th className="small-font">
                <span className="has-sorting">
                  <div className="d-flex">
                    ...
                    >
                      <FilterIcon fillColor={`${filterValues.classification.length > 0 ? '#2f5aa3' : '#36454F'}`}/>
                    </span>
                  </div>
                </span>
              </th>
