...
const ProjectLogsReader = ({
  ...
  const loadPDF = async () => {
    ...
    try {
      ...
      _webViewer.UI.updateElement("menuButton", {
      ...
      _webViewer.UI.updateElement("leftPanelButton", {
        img: `<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      _webViewer.UI.updateElement("viewControlsButton", {
        img: `<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      setLoading(false);
      console.log(`It is failed err=${e}`);
    }
  };
  return (
    <>
